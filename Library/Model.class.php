...
class Model {
     ...
     * 
     * @access public
     * @param string $defaultDB 默认是连接哪个数据库，具体的值在数据库配置文件里面，
     *                          如果需要修改连接的话，在模型的构造函数里修改
     *           localhost, localhost_wsdl, remote_1, remote_2, slave
     *           
