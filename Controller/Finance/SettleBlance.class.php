    ...
    public function getRecords() {
        ...
        foreach($list as $item) {
            ...
            $res['list'][] = [
                ...
                'status'         => $status,
                'freeze_money'   => $item['freeze_money'] != -1 ? round($item['freeze_money'] / 100, 2) : $item['freeze_money'],
                'transfer_money' => $item['transfer_money'] != -1 ? round($item['transfer_money'] / 100, 2) : $item['transfer_money'],
